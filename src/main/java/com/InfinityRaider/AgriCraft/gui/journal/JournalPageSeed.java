...
public class JournalPageSeed extends JournalPage {
    ...
    private ArrayList<IMutation> getDiscoveredParentMutations() {
        ...
        ArrayList<IMutation> allMutations = new ArrayList<>(Arrays.asList(MutationHandler.getInstance().getMutationsFromParent(discoveredSeeds.get(page))));
    ...
    private ArrayList<IMutation> getDiscoveredChildMutations() {
        ArrayList<IMutation> mutations = new ArrayList<>();
        ArrayList<IMutation> allMutations = new ArrayList<>(Arrays.asList(MutationHandler.getInstance().getMutationsFromChild(discoveredSeeds.get(page))));
        for (IMutation mutation : allMutations) {
            if (isMutationDiscovered(mutation)) {
                mutations.add(mutation);
            }
