...
public class CropPlantGardenStuff extends CropPlant {
    private final Item seed;
    private final Block plant;
    private final Item fruit;

    protected CropPlantGardenStuff(Item seed, Block plant, Item fruit) {
        super();
        this.seed = seed;
        this.plant = plant;
        this.fruit = fruit;
    ...
    public String getInformation() {
        ...
        return "agricraft_journal.gardenstuff_"+(split.length == 0 ? name : split[split.length-1]);
    }
}
