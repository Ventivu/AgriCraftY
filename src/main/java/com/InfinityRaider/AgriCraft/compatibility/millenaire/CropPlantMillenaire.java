...
public class CropPlantMillenaire extends CropPlant {
    private final Block plant;
    private final Item fruit;

    protected CropPlantMillenaire(Block plant, Item fruit) {
        super();
        this.plant = plant;
        this.fruit = fruit;
    }
    ...
    public String getInformation() {
        String name = plant.getUnlocalizedName();
        String[] split = name.split("_");
        return "agricraft_journal.millenaire_"+(split.length == 0 ? name : split[split.length-1]);
    }
}
